...
5. Telegram Bot API para interface conversacional opcional.
6. GitHub Actions para lint, testes e build.

## Fronteiras de confiança

- O navegador não recebe segredos do backend.
- Tokens do Telegram e chaves de integração ficam no Secret Manager.
