      ...
      <div className="flex-1">
        ...
        <p className="text-[10px] text-[--text-tertiary]">
          {rate >= 20
            ...
            : rate >= 10
              ? 'Poupança entre 10–20%. Tente aumentar.'
        ...
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <KPI
              ...
              tooltip="Total de entradas no período."
            />
            <KPI
              label="Despesas"
              ...
              tooltip="Total de saídas no período."
            />
            <KPI
              label="Saldo"
                    ...
                    <div className="mt-4 p-3 bg-[--bg-subtle] rounded-xl">
                      ...
                      <div className="h-2 bg-[--bg-hover] rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, periodTotals.income > 0 ? (periodTotals.savings / periodTotals.income) * 100 : 0)}%`,
                          }}
                        />
                      </div>
                    </div>
